...
val fail = Fail("Some error message").withEx(exception)
...
* run `sbt fmt` and clean warning
* clean compilation error and warning
...
// TODO : How we handle SOAP, hint JAXB vs Manual xml
